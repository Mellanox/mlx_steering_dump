...
class dr_parse_context:
    ...
    def dump_str(self, verbosity):
        return dump_obj_str(
            ["mlx5dr_debug_res_type", "id", "hws_support", "dev_name", "debug_version"],
            self.data,
        )
    ...
    def fix_data(self):
        self.data["hws_support"] = (
            "True" if self.data["hws_support"] is "1" else "False"
        )
...
class dr_parse_context_attr:
    def __init__(self, data):
        ...
        shared_dev_name = (
            ...
            else self.data.get("shared_dev_name")
        )
...
class dr_parse_context_caps:
    def __init__(self, data):
        ...
        _config_args["linear_match_definer_field_name"] = self.data.get(
            "linear_match_definer_field_name"
        )
