...
DR_TBL_TYPE_FDB_UNIFIED = 'FDB_U'

DR_ROOT_TBL_LEVEL = 0

dr_table_type = [DR_TBL_TYPE_NIC_RX, DR_TBL_TYPE_NIC_TX, DR_TBL_TYPE_FDB, DR_TBL_TYPE_FDB_RX, DR_TBL_TYPE_FDB_TX, DR_TBL_TYPE_FDB_UNIFIED]
