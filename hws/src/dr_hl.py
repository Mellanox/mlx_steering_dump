...
def dr_hl_dw_mask_parser(dw_fields, mask):
    ...
    for i in range(len(dw_fields)):
        ...
        field_bits = bin(
            int("1" + (dw_fields[i][1] * "1"), 2)
            & int("1" + mask[_len : _len + dw_fields[i][1]], 2)
        )
        # Remove the "0b1" prefix of the binary string
        fields_arr.append(
            (dw_fields[i][0], str(field_bits)[3:])
        )
        _len += dw_fields[i][1]
...
def dr_hl_eth_l3_parser(hl_index, mask):
    ...
    dw_fields = [
        [
            ...
            ("dscp", 6),
            ("ecn", 2),
            ("time_to_live_hop_limit", 8),
            ("protocol_next_header", 8),
        ],
...
def dr_hl_oks1_parser(hl_index, mask):
    ...
    dw_fields = [
        [
            ("second_ipv4_checksum_ok", 1),
            ("second_l4_checksum_ok", 1),
            ("first_ipv4_checksum_ok", 1),
            ("first_l4_checksum_ok", 1),
            ("second_l3_ok", 1),
            ("second_l4_ok", 1),
            ("first_l3_ok", 1),
            ("first_l4_ok", 1),
            ("flex_parser7_steering_ok", 1),
            ("flex_parser6_steering_ok", 1),
            ("flex_parser5_steering_ok", 1),
            ("flex_parser4_steering_ok", 1),
            ("flex_parser3_steering_ok", 1),
            ("flex_parser2_steering_ok", 1),
            ("flex_parser1_steering_ok", 1),
            ("flex_parser0_steering_ok", 1),
            ("second_ipv6_extension_header_vld", 1),
            ("first_ipv6_extension_header_vld", 1),
            ("l3_tunneling_ok", 1),
            ("l2_tunneling_ok", 1),
            ("second_tcp_ok", 1),
            ("second_udp_ok", 1),
...
def dr_hl_oks2_parser(hl_index, mask):
    ...
    dw_fields = [
        [
            ("reserved_at_0", 10),
            ("second_mpls_ok", 1),
            ("second_mpls4_s_bit", 1),
            ("second_mpls4_qualifier", 1),
            ("second_mpls3_s_bit", 1),
            ("second_mpls3_qualifier", 1),
            ("second_mpls2_s_bit", 1),
            ("second_mpls2_qualifier", 1),
            ("second_mpls1_s_bit", 1),
            ("second_mpls1_qualifier", 1),
            ("second_mpls0_s_bit", 1),
            ("second_mpls0_qualifier", 1),
            ("first_mpls_ok", 1),
            ("first_mpls4_s_bit", 1),
            ("first_mpls4_qualifier", 1),
            ("first_mpls3_s_bit", 1),
            ("first_mpls3_qualifier", 1),
            ("first_mpls2_s_bit", 1),
            ("first_mpls2_qualifier", 1),
            ("first_mpls1_s_bit", 1),
            ("first_mpls1_qualifier", 1),
            ("first_mpls0_s_bit", 1),
            ("first_mpls0_qualifier", 1),
        ]
    ]
...
def dr_hl_udp_misc_parser(hl_index, mask):
    ...
    dw_fields = [[("length", 16), ("TCP/UDP Checksum", 16)]]
...
def dr_hl_configurable_headers_parser(hl_index, mask):
    ...
    dw_fields = [
        [
            ("eth_l2_config_header0_present", 1),
            ("reserved", 15),
            ("eth_l2_config_header0", 16),
        ],
        [("eth_l2_config_header0_dw", 32)],
        [
            ("eth_l2_config_header1_present", 1),
            ("reserved", 15),
...
def dr_hl_random_number_parser(hl_index, mask):
    ...
    dw_fields = [[("random_number", 16), ("reserved", 16)]]
...
def dr_hl_ipsec_parser(hl_index, mask):
    ...
    dw_fields = [
        [("SPI", 32)],
        [("sequence_number", 32)],
        [("reserved", 16), ("IPSec_syndrome", 8), ("IPSec_next_header", 8)],
    ]
...
def dr_hl_general_purpose_field_parser(hl_index, mask):
    ...
    dw_fields = [[("general_purpose_lookup_field", 32)]]
...
def dr_hl_accumulated_hash_parser(hl_index, mask):
    ...
    dw_fields = [[("accumulated_hash_register", 32)]]
...
def dr_hl_utc_timestamp_parser(hl_index, mask):
    ...
    dw_fields = [[("utc_timestamp_h", 32)], [("utc_timestamp_l", 32)]]
...
def dr_hl_free_runing_timestamp_parser(hl_index, mask):
    ...
    dw_fields = [[("frc_timestamp_h", 32)], [("frc_timestamp_l", 32)]]
...
def dr_hl_ib_l3_extended_parser(hl_index, mask):
    ...
    dw_fields = [
        [("ip_ver", 1), ("reserved", 3), ("traffic_class", 8), ("flow_label", 20)],
        [("q_key", 32)],
    ]
...
def dr_hl_rwh_parser(hl_index, mask):
    ...
    dw_fields = [[("reserved", 16), ("rwh_ethertype", 16)]]
...
def dr_hl_dcceth_parser(hl_index, mask):
    ...
    dw_fields = [
        [("dc_control_request_opcode", 4), ("dc_path_parameters", 8), ("reserved", 16)]
    ]
